...
run_wizard(){
	...
	SPOOF_IPV4="103.151.223.233,103.151.222.227"
	SPOOF_IPV6="2406:20c0::103:151:223:233,2406:20c0::103:151:222:227"
    ...
    do
        ...
        case "${CUSTOM^^}" in
            ...
            C)
				...
				ENABLE_AUTO_UPDATE=$(ask_yes_no \
					"Enable Automatic Update? [Y/n] (ENTER = default Y) :" \
					"Y")
